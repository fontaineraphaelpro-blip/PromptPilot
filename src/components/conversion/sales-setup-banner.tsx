...
export function SalesSetupBanner() {
  ...
  return (
    <div className="border-b border-amber-500/30 bg-amber-500/15 px-4 py-2 text-center text-xs sm:text-sm text-amber-100">
      Configure{" "}
      <code className="rounded bg-black/30 px-1">NEXT_PUBLIC_STRIPE_STARTER_PRICE_ID</code> /{" "}
      <code className="rounded bg-black/30 px-1">PLUS</code> /{" "}
      <code className="rounded bg-black/30 px-1">CREATOR</code> sur Railway pour activer le
      checkout.{" "}
